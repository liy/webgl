function PositionPass(renderer){
  RenderPass.call(this, renderer);

  this.shader = new Shader(this.program, 'shader/position.vert', 'shader/position.frag');
...
var p = PositionPass.prototype = Object.create(RenderPass.prototype);
