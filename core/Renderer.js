...
p.render = function(scene, camera){
  ...
  for(i=0; i<len; ++i){
    ...
    vec3.transformMat4(scene.meshes[i]._viewSpacePosition, Node.origin, scene.meshes[i].modelViewMatrix);
  }
  ...
  for(i=0; i<len; ++i){
    ...
    vec3.transformMat4(scene.lights[i]._viewSpacePosition, Node.origin, scene.lights[i].modelViewMatrix);
  }
